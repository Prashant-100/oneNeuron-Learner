...
def prepare_data(df):
    ...
    Returns:
        tuples: It returns the tuples of the dependent variables and independent variables
    """
...
def save_plot(df, file_name, model):
    ...
    :param file_name:It's a path to save the plot to
    :param model: It's the trained model'
    """
